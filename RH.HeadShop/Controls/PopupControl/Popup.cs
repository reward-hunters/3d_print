...
*/
namespace RH.HeadShop.Controls.PopupControl
{
    /// <summary>
    ...
    public partial class Popup : ToolStripDropDown
    {
        ...
        protected override void OnVisibleChanged(EventArgs e)
        {
            ...
            var flags = Visible ? NativeMethods.AnimationFlags.Roll : NativeMethods.AnimationFlags.Hide;
            var _flags = Visible ? ShowingAnimation : HidingAnimation;
        ...
        protected override bool ProcessDialogKey(Keys keyData)
        {
            ...
            var processed = base.ProcessDialogKey(keyData);
            if (!processed && (keyData == Keys.Tab || keyData == (Keys.Tab | Keys.Shift)))
            {
                var backward = (keyData & Keys.Shift) == Keys.Shift;
        ...
        public void Show(Rectangle area)
        {
            ...
            var location = new Point(area.Left, area.Top + area.Height);
        ...
        protected override void OnLayout(LayoutEventArgs e)
        {
            ...
            var suggestedSize = GetPreferredSize(Size.Empty);
        ...
        private bool OnNcHitTest(ref Message m, bool contentControl)
        {
            ...
            var x = Cursor.Position.X; // NativeMethods.LOWORD(m.LParam);
            var y = Cursor.Position.Y; // NativeMethods.HIWORD(m.LParam);
